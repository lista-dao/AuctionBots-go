...
// FlashBuyAuction is a paid mutator transaction binding the contract method 0x738274a7.
//
// Solidity: function flashBuyAuction(address token, uint256 auctionId, uint256 borrowAm, address collateral, uint256 collateralAm, uint256 maxPrice, address collateralReal, bytes path) returns()
func (_Flashbuy *FlashbuyTransactor) FlashBuyAuction(opts *bind.TransactOpts, token common.Address, auctionId *big.Int, borrowAm *big.Int, collateral common.Address, collateralAm *big.Int, maxPrice *big.Int, collateralReal common.Address, path []byte) (*types.Transaction, error) {
	return _Flashbuy.contract.Transact(opts, "flashBuyAuction", token, auctionId, borrowAm, collateral, collateralAm, maxPrice, collateralReal, path)
}

// FlashBuyAuction is a paid mutator transaction binding the contract method 0x738274a7.
//
// Solidity: function flashBuyAuction(address token, uint256 auctionId, uint256 borrowAm, address collateral, uint256 collateralAm, uint256 maxPrice, address collateralReal, bytes path) returns()
func (_Flashbuy *FlashbuySession) FlashBuyAuction(token common.Address, auctionId *big.Int, borrowAm *big.Int, collateral common.Address, collateralAm *big.Int, maxPrice *big.Int, collateralReal common.Address, path []byte) (*types.Transaction, error) {
	return _Flashbuy.Contract.FlashBuyAuction(&_Flashbuy.TransactOpts, token, auctionId, borrowAm, collateral, collateralAm, maxPrice, collateralReal, path)
}

// FlashBuyAuction is a paid mutator transaction binding the contract method 0x738274a7.
//
// Solidity: function flashBuyAuction(address token, uint256 auctionId, uint256 borrowAm, address collateral, uint256 collateralAm, uint256 maxPrice, address collateralReal, bytes path) returns()
func (_Flashbuy *FlashbuyTransactorSession) FlashBuyAuction(token common.Address, auctionId *big.Int, borrowAm *big.Int, collateral common.Address, collateralAm *big.Int, maxPrice *big.Int, collateralReal common.Address, path []byte) (*types.Transaction, error) {
	return _Flashbuy.Contract.FlashBuyAuction(&_Flashbuy.TransactOpts, token, auctionId, borrowAm, collateral, collateralAm, maxPrice, collateralReal, path)
}
