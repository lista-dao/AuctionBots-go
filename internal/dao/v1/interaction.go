...
// EstimatedLiquidationPriceSIKKA is a free data retrieval call binding the contract method 0xd12d9c02.
//
// Solidity: function estimatedLiquidationPriceSIKKA(address token, address usr, int256 amount) view returns(uint256)
func (_Interaction *InteractionCaller) EstimatedLiquidationPriceSIKKA(opts *bind.CallOpts, token common.Address, usr common.Address, amount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Interaction.contract.Call(opts, &out, "estimatedLiquidationPriceSIKKA", token, usr, amount)
...
//
// Solidity: function estimatedLiquidationPriceSIKKA(address token, address usr, int256 amount) view returns(uint256)
func (_Interaction *InteractionSession) EstimatedLiquidationPriceSIKKA(token common.Address, usr common.Address, amount *big.Int) (*big.Int, error) {
	return _Interaction.Contract.EstimatedLiquidationPriceSIKKA(&_Interaction.CallOpts, token, usr, amount)
}

// EstimatedLiquidationPriceSIKKA is a free data retrieval call binding the contract method 0xd12d9c02.
//
// Solidity: function estimatedLiquidationPriceSIKKA(address token, address usr, int256 amount) view returns(uint256)
func (_Interaction *InteractionCallerSession) EstimatedLiquidationPriceSIKKA(token common.Address, usr common.Address, amount *big.Int) (*big.Int, error) {
	return _Interaction.Contract.EstimatedLiquidationPriceSIKKA(&_Interaction.CallOpts, token, usr, amount)
}
...
// IkkaRewards is a free data retrieval call binding the contract method 0xccc6486f.
//
// Solidity: function ikkaRewards() view returns(address)
func (_Interaction *InteractionCaller) IkkaRewards(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Interaction.contract.Call(opts, &out, "ikkaRewards")
...
//
// Solidity: function ikkaRewards() view returns(address)
func (_Interaction *InteractionSession) IkkaRewards() (common.Address, error) {
	return _Interaction.Contract.IkkaRewards(&_Interaction.CallOpts)
}

// IkkaRewards is a free data retrieval call binding the contract method 0xccc6486f.
//
// Solidity: function ikkaRewards() view returns(address)
func (_Interaction *InteractionCallerSession) IkkaRewards() (common.Address, error) {
	return _Interaction.Contract.IkkaRewards(&_Interaction.CallOpts)
}
...
// Sikka is a free data retrieval call binding the contract method 0x3854f815.
//
// Solidity: function sikka() view returns(address)
func (_Interaction *InteractionCaller) Sikka(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Interaction.contract.Call(opts, &out, "sikka")
...
//
// Solidity: function sikka() view returns(address)
func (_Interaction *InteractionSession) Sikka() (common.Address, error) {
	return _Interaction.Contract.Sikka(&_Interaction.CallOpts)
}

// Sikka is a free data retrieval call binding the contract method 0x3854f815.
//
// Solidity: function sikka() view returns(address)
func (_Interaction *InteractionCallerSession) Sikka() (common.Address, error) {
	return _Interaction.Contract.Sikka(&_Interaction.CallOpts)
}

// SikkaJoin is a free data retrieval call binding the contract method 0x74de9ba0.
//
// Solidity: function sikkaJoin() view returns(address)
func (_Interaction *InteractionCaller) SikkaJoin(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Interaction.contract.Call(opts, &out, "sikkaJoin")
...
//
// Solidity: function sikkaJoin() view returns(address)
func (_Interaction *InteractionSession) SikkaJoin() (common.Address, error) {
	return _Interaction.Contract.SikkaJoin(&_Interaction.CallOpts)
}

// SikkaJoin is a free data retrieval call binding the contract method 0x74de9ba0.
//
// Solidity: function sikkaJoin() view returns(address)
func (_Interaction *InteractionCallerSession) SikkaJoin() (common.Address, error) {
	return _Interaction.Contract.SikkaJoin(&_Interaction.CallOpts)
}

// SikkaPrice is a free data retrieval call binding the contract method 0xb73bd344.
//
// Solidity: function sikkaPrice(address token) view returns(uint256)
func (_Interaction *InteractionCaller) SikkaPrice(opts *bind.CallOpts, token common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Interaction.contract.Call(opts, &out, "sikkaPrice", token)
...
//
// Solidity: function sikkaPrice(address token) view returns(uint256)
func (_Interaction *InteractionSession) SikkaPrice(token common.Address) (*big.Int, error) {
	return _Interaction.Contract.SikkaPrice(&_Interaction.CallOpts, token)
}

// SikkaPrice is a free data retrieval call binding the contract method 0xb73bd344.
//
// Solidity: function sikkaPrice(address token) view returns(uint256)
func (_Interaction *InteractionCallerSession) SikkaPrice(token common.Address) (*big.Int, error) {
	return _Interaction.Contract.SikkaPrice(&_Interaction.CallOpts, token)
}

// SikkaProviders is a free data retrieval call binding the contract method 0x156eaba2.
//
// Solidity: function sikkaProviders(address ) view returns(address)
func (_Interaction *InteractionCaller) SikkaProviders(opts *bind.CallOpts, arg0 common.Address) (common.Address, error) {
	var out []interface{}
	err := _Interaction.contract.Call(opts, &out, "sikkaProviders", arg0)
...
//
// Solidity: function sikkaProviders(address ) view returns(address)
func (_Interaction *InteractionSession) SikkaProviders(arg0 common.Address) (common.Address, error) {
	return _Interaction.Contract.SikkaProviders(&_Interaction.CallOpts, arg0)
}

// SikkaProviders is a free data retrieval call binding the contract method 0x156eaba2.
//
// Solidity: function sikkaProviders(address ) view returns(address)
func (_Interaction *InteractionCallerSession) SikkaProviders(arg0 common.Address) (common.Address, error) {
	return _Interaction.Contract.SikkaProviders(&_Interaction.CallOpts, arg0)
}
...
//
// Solidity: function borrow(address token, uint256 sikkaAmount) returns(uint256)
func (_Interaction *InteractionTransactor) Borrow(opts *bind.TransactOpts, token common.Address, sikkaAmount *big.Int) (*types.Transaction, error) {
	return _Interaction.contract.Transact(opts, "borrow", token, sikkaAmount)
}

// Borrow is a paid mutator transaction binding the contract method 0x4b8a3529.
//
// Solidity: function borrow(address token, uint256 sikkaAmount) returns(uint256)
func (_Interaction *InteractionSession) Borrow(token common.Address, sikkaAmount *big.Int) (*types.Transaction, error) {
	return _Interaction.Contract.Borrow(&_Interaction.TransactOpts, token, sikkaAmount)
}

// Borrow is a paid mutator transaction binding the contract method 0x4b8a3529.
//
// Solidity: function borrow(address token, uint256 sikkaAmount) returns(uint256)
func (_Interaction *InteractionTransactorSession) Borrow(token common.Address, sikkaAmount *big.Int) (*types.Transaction, error) {
	return _Interaction.Contract.Borrow(&_Interaction.TransactOpts, token, sikkaAmount)
}
...
//
// Solidity: function initialize(address vat_, address spot_, address sikka_, address sikkaJoin_, address jug_, address dog_, address rewards_) returns()
func (_Interaction *InteractionTransactor) Initialize(opts *bind.TransactOpts, vat_ common.Address, spot_ common.Address, sikka_ common.Address, sikkaJoin_ common.Address, jug_ common.Address, dog_ common.Address, rewards_ common.Address) (*types.Transaction, error) {
	return _Interaction.contract.Transact(opts, "initialize", vat_, spot_, sikka_, sikkaJoin_, jug_, dog_, rewards_)
}

// Initialize is a paid mutator transaction binding the contract method 0x35876476.
//
// Solidity: function initialize(address vat_, address spot_, address sikka_, address sikkaJoin_, address jug_, address dog_, address rewards_) returns()
func (_Interaction *InteractionSession) Initialize(vat_ common.Address, spot_ common.Address, sikka_ common.Address, sikkaJoin_ common.Address, jug_ common.Address, dog_ common.Address, rewards_ common.Address) (*types.Transaction, error) {
	return _Interaction.Contract.Initialize(&_Interaction.TransactOpts, vat_, spot_, sikka_, sikkaJoin_, jug_, dog_, rewards_)
}

// Initialize is a paid mutator transaction binding the contract method 0x35876476.
//
// Solidity: function initialize(address vat_, address spot_, address sikka_, address sikkaJoin_, address jug_, address dog_, address rewards_) returns()
func (_Interaction *InteractionTransactorSession) Initialize(vat_ common.Address, spot_ common.Address, sikka_ common.Address, sikkaJoin_ common.Address, jug_ common.Address, dog_ common.Address, rewards_ common.Address) (*types.Transaction, error) {
	return _Interaction.Contract.Initialize(&_Interaction.TransactOpts, vat_, spot_, sikka_, sikkaJoin_, jug_, dog_, rewards_)
}

// Payback is a paid mutator transaction binding the contract method 0x35ed8ab8.
//
// Solidity: function payback(address token, uint256 sikkaAmount) returns(int256)
func (_Interaction *InteractionTransactor) Payback(opts *bind.TransactOpts, token common.Address, sikkaAmount *big.Int) (*types.Transaction, error) {
	return _Interaction.contract.Transact(opts, "payback", token, sikkaAmount)
}

// Payback is a paid mutator transaction binding the contract method 0x35ed8ab8.
//
// Solidity: function payback(address token, uint256 sikkaAmount) returns(int256)
func (_Interaction *InteractionSession) Payback(token common.Address, sikkaAmount *big.Int) (*types.Transaction, error) {
	return _Interaction.Contract.Payback(&_Interaction.TransactOpts, token, sikkaAmount)
}

// Payback is a paid mutator transaction binding the contract method 0x35ed8ab8.
//
// Solidity: function payback(address token, uint256 sikkaAmount) returns(int256)
func (_Interaction *InteractionTransactorSession) Payback(token common.Address, sikkaAmount *big.Int) (*types.Transaction, error) {
	return _Interaction.Contract.Payback(&_Interaction.TransactOpts, token, sikkaAmount)
}
...
//
// Solidity: function setCores(address vat_, address spot_, address sikkaJoin_, address jug_) returns()
func (_Interaction *InteractionTransactor) SetCores(opts *bind.TransactOpts, vat_ common.Address, spot_ common.Address, sikkaJoin_ common.Address, jug_ common.Address) (*types.Transaction, error) {
	return _Interaction.contract.Transact(opts, "setCores", vat_, spot_, sikkaJoin_, jug_)
}

// SetCores is a paid mutator transaction binding the contract method 0xc43bf141.
//
// Solidity: function setCores(address vat_, address spot_, address sikkaJoin_, address jug_) returns()
func (_Interaction *InteractionSession) SetCores(vat_ common.Address, spot_ common.Address, sikkaJoin_ common.Address, jug_ common.Address) (*types.Transaction, error) {
	return _Interaction.Contract.SetCores(&_Interaction.TransactOpts, vat_, spot_, sikkaJoin_, jug_)
}

// SetCores is a paid mutator transaction binding the contract method 0xc43bf141.
//
// Solidity: function setCores(address vat_, address spot_, address sikkaJoin_, address jug_) returns()
func (_Interaction *InteractionTransactorSession) SetCores(vat_ common.Address, spot_ common.Address, sikkaJoin_ common.Address, jug_ common.Address) (*types.Transaction, error) {
	return _Interaction.Contract.SetCores(&_Interaction.TransactOpts, vat_, spot_, sikkaJoin_, jug_)
}
...
// SetSikkaApprove is a paid mutator transaction binding the contract method 0xd6ad1c8a.
//
// Solidity: function setSikkaApprove() returns()
func (_Interaction *InteractionTransactor) SetSikkaApprove(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Interaction.contract.Transact(opts, "setSikkaApprove")
}

// SetSikkaApprove is a paid mutator transaction binding the contract method 0xd6ad1c8a.
//
// Solidity: function setSikkaApprove() returns()
func (_Interaction *InteractionSession) SetSikkaApprove() (*types.Transaction, error) {
	return _Interaction.Contract.SetSikkaApprove(&_Interaction.TransactOpts)
}

// SetSikkaApprove is a paid mutator transaction binding the contract method 0xd6ad1c8a.
//
// Solidity: function setSikkaApprove() returns()
func (_Interaction *InteractionTransactorSession) SetSikkaApprove() (*types.Transaction, error) {
	return _Interaction.Contract.SetSikkaApprove(&_Interaction.TransactOpts)
}

// SetSikkaProvider is a paid mutator transaction binding the contract method 0x7d61e209.
//
// Solidity: function setSikkaProvider(address token, address sikkaProvider) returns()
func (_Interaction *InteractionTransactor) SetSikkaProvider(opts *bind.TransactOpts, token common.Address, sikkaProvider common.Address) (*types.Transaction, error) {
	return _Interaction.contract.Transact(opts, "setSikkaProvider", token, sikkaProvider)
}

// SetSikkaProvider is a paid mutator transaction binding the contract method 0x7d61e209.
//
// Solidity: function setSikkaProvider(address token, address sikkaProvider) returns()
func (_Interaction *InteractionSession) SetSikkaProvider(token common.Address, sikkaProvider common.Address) (*types.Transaction, error) {
	return _Interaction.Contract.SetSikkaProvider(&_Interaction.TransactOpts, token, sikkaProvider)
}

// SetSikkaProvider is a paid mutator transaction binding the contract method 0x7d61e209.
//
// Solidity: function setSikkaProvider(address token, address sikkaProvider) returns()
func (_Interaction *InteractionTransactorSession) SetSikkaProvider(token common.Address, sikkaProvider common.Address) (*types.Transaction, error) {
	return _Interaction.Contract.SetSikkaProvider(&_Interaction.TransactOpts, token, sikkaProvider)
}
...
//
// Solidity: event Borrow(address indexed user, address collateral, uint256 amount, uint256 liquidationPrice)
...
//
// Solidity: event Liquidation(address user, address indexed collateral, uint256 amount, uint256 price)
func (_Interaction *InteractionFilterer) FilterLiquidation(opts *bind.FilterOpts, collateral []common.Address) (*InteractionLiquidationIterator, error) {
	...
	logs, sub, err := _Interaction.contract.FilterLogs(opts, "Liquidation", collateralRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Liquidation(address user, address indexed collateral, uint256 amount, uint256 price)
func (_Interaction *InteractionFilterer) WatchLiquidation(opts *bind.WatchOpts, sink chan<- *InteractionLiquidation, collateral []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Interaction.contract.WatchLogs(opts, "Liquidation", collateralRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
