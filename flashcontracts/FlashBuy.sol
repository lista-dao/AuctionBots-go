...
contract FlashBuy is IERC3156FlashBorrower {
    ...
    constructor (IERC3156FlashLender lender_, IAuctionProxy auction_, IDEX dex_, IERC20 main_) {
        lender = lender_;
        auction = auction_;
        dex = dex_;
        main = main_;
    ...
    function onFlashLoan(
        ...
        require(main.balanceOf(address(this))>0, "buy is failed");
        ...
        path[3] = token;
        dex.swapTokensForExactTokens(minOut, main.balanceOf(address(this)), path, address(this), block.timestamp + 300);
